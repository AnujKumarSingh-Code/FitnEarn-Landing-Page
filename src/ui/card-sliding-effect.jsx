        ...
        .map((item, idx) => (
          ...
          >
            <AnimatePresence>
              {hoveredIndex === idx && (
                <motion.span
                  className="absolute inset-0 h-full w-full  bg-zinc-500 block rounded-3xl"
...
export const Card = ({
  ...
  return (
    (<div
      className={cn(
        "flex flex-col items-center justify-center w-80 p-6 bg-zinc-700 text-white rounded-3xl h-full border-transparent group-hover:shadow-lg transition-shadow duration-300",
        className
      )}>
